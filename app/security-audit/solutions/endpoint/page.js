// app/security-audit/solutions/endpoint/page.js
  ...
  return (
    <div>
      ...
      <div className="section">
        ...
        <p>
          엔드포인트 보안 솔루션의 올바른 설치 및 구성 방법을 안내합니다.
          엔드포인트 보안은 PC, 노트북 등 사용자 장치의 보안을 강화하는 중요한
          요소입니다.
        </p>
      </div>
      ...
      <div className="section">
        ...
        <ol style={{ marginLeft: "20px", marginTop: "10px" }}>
          ...
          <li>
            작업 표시줄 트레이에서 보안 솔루션 아이콘이 활성화되어 있는지
            확인합니다.
          </li>
        </ol>
      </div>
      ...
      <div className="section">
        ...
        <p>
          엔드포인트 보안 솔루션 설치 또는 구성에 문제가 있는 경우 아래
          담당자에게 문의하세요:
        </p>
