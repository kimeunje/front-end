  ...
  return (
    <div>
      ...
      <div className="section">
        ...
        <p>시스템에 설치된 불필요한 프린터를 제거하여 보안 위험을 줄이는 방법을 안내합니다.</p>
      </div>
      
      <div className="section">
        <h2 className="section-title">보안 위험</h2>
        <p>허가되지 않은 프린터가 설치되어 있을 경우 다음과 같은 보안 위험이 있습니다:</p>
      ...
      <div className="section">
        ...
        <p>업무에 필수적으로 사용해야 하는 프린터가 있는 경우, 운영심(2533)으로 문의하여 예외 승인을 받을 수 있습니다.</p>
      </div>
